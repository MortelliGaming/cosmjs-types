...
export const QueryPoolsWithFilterRequest = {
  ...
  fromJSON(object: any): QueryPoolsWithFilterRequest {
    ...
    if (isSet(object.minLiquidity)) obj.minLiquidity = String(object.minLiquidity);
    if (isSet(object.poolType)) obj.poolType = String(object.poolType);
    if (isSet(object.pagination)) obj.pagination = PageRequest.fromJSON(object.pagination);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<QueryPoolsWithFilterRequest>, I>>(
    object: I,
...
export const QueryPoolsWithFilterResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryPoolsWithFilterResponse>, I>>(
    object: I,
...
export const QueryCFMMConcentratedPoolLinksRequest = {
  ...
  encode(
    _: QueryCFMMConcentratedPoolLinksRequest,
    writer: BinaryWriter = BinaryWriter.create(),
  ): BinaryWriter {
    return writer;
  },
